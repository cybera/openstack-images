...
TEMP_ID=`glance image-create --disk-format qcow2 --container-format bare --file ubuntu-12.04-server-cloudimg-amd64-disk1.img --name TempUbuntu12Image | grep id | awk ' { print $4 }'`
